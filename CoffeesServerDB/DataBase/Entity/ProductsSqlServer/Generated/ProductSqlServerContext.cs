...
{
    public partial class ProductSqlServerContext : DbContext
    {
        public ProductSqlServerContext()
        {
        }

        public ProductSqlServerContext(DbContextOptions<ProductSqlServerContext> options)
            : base(options)
        {
        }
